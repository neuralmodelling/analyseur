"""
=======================================================
Population-level neural activity and summary statistics
=======================================================
...
def main():
    ...
    for i, region in enumerate(regionfolders):
        ...
        for folder_id in decayfolderid.keys():
            ...
            ax2, _, _ = plotCV_in_ax(ax2, spiketimes_set, mode="portrait")

            ax3 = plot_mean_rate_spikecounts_in_ax(ax3, spiketimes_set, mode="portrait")
            # if neurons=="all":
            ...
            ax4 = VizPSTH.plot_pool_in_ax(ax4, spiketimes_set, window=window, binsz=binsz,
                                        nucleus=nucleus, neurons=neurons)

            ax5 = VizPopAct.plot_popcount_dist_in_ax(ax5, spiketimes_set, binsz=binsz,
                                                    nucleus=nucleus)

            plt.tight_layout()
            #
            Path("raster_all").mkdir(parents=True, exist_ok=True)
