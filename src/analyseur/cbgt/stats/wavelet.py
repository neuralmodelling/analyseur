...
class WaveletTransform(object):
    ...
    def __get_smoothed_signal(spiketimes_superset, sampling_rate=None,
        ...
        return gaussian_filter1d(spiketrains, sigma=sigma), yticks, time_axis

    @classmethod
    def compute_cwt(cls, spiketimes_superset, sampling_rate=None,
                window=None, neurons=None, sigma=None,
        ...
        [smoothed_signal, yticks, time_axis] = \
        ...
        coefficients, frequencies = pywt.cwt(smoothed_signal, scales, wavelet, sampling_period=sampling_period)
