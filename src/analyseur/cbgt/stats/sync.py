        ...
        **Formula**
        ...
        .. math::
            ...
            F = \\overset{\\begin{matrix}t_0 & \\quad\\quad & t_1 & & & &\\ldots & & & t_T\\end{matrix}}
                {\\underset{
                    \\begin{matrix}
                        \\quad\\quad\\uparrow & \\quad\\quad\\quad\\quad\\quad\\quad & \\uparrow & &\\ldots & & & \\uparrow \n
                        \\quad\\mu_{t_0} & \\quad\\quad\\quad\\quad\\quad\\quad & \\mu_{t_1} & &\\ldots & & & \\mu_{t_T} & \\rightarrow var_{\\forall{t}}
                    \\end{matrix}}
               {\\begin{bmatrix}
