    ...
    def compute_basic(cls, spiketimes_superset, binsz=0.05, window=(0, 10)):
        ...
        **Formula**
            ...
            F = \\overset{\\begin{matrix}t_0 & \\quad\\quad\\quad & t_1 & & & &\\ldots & & & t_T\\end{matrix}}
                {\\underset{
                    \\begin{matrix}
                        ...
                        \\quad\\quad\\quad\\quad\\mu_{t_0} & \\quad\\quad\\quad\\quad & \\mu_{t_1} & &\\ldots & & & \\mu_{t_T} & \\rightarrow var_{\\forall{t}}
                    \\end{matrix}}
               {\\begin{bmatrix}
        ...
        .. math::
            ...
            Sync = \\frac{A}{B} = \\sqrt{\\frac{var\\left(\\left[\\mu\\left(\\left[f^{{i}}(t)\\right]_{\\forall{t}}\\right)\\right]_{\\forall{i}}\\right)}{\\mu\\left(\\left[var\\left(\\left[f^{(i)}(t)\\right]_{\\forall{i}}\\right)\\right]_{\\forall{t}}\\right)}}
