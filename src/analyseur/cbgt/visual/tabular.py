...
class SpikingStats(object):
    ...
    def _compute_ISI(self, all_neurons_isi):
        # isi = InterSpikeInterval.compute(self.spiketrains)
    ...
    def compute_stats(self, spiketrains):
        all_isi = InterSpikeInterval.compute(spiketrains)
    ...
    def plot(self):
        computed_stats = self.compute_stats(self.spiketrains)
